...
1.  **Open the source code and start editing!**
    ...
    Open the `hello-world` directory in your code editor of choice and edit `src/pages/index.js` or `src/pages/blog.js`. Save your changes and the browser will update in real time!
